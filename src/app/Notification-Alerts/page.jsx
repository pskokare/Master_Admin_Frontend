...
export default function NotificationsPage() {
  ...
  return (
    <div className="bg-gray-900 h-[102%] text-white p-6 flex flex-col gap-6">
      ...
      >
        <h1 className="text-3xl font-extrabold  mt-6">Notifications & Alerts</h1>
        <motion.button
          whileHover={{ scale: 1.1, rotate: 5 }}
          whileTap={{ scale: 0.9 }}
          className="bg-gray-800 px-4 py-2 rounded-lg ml-5 flex items-center gap-2 shadow-lg hover:bg-gray-700"
        >
